...
class Misc
{
     ...
     *                       null     - string to display if $str is null, or set to TRUE to use a default 'NULL'
     *                       string, otherwise nothing is rendered. clip     - if true, clip the value to a fixed
     *                       length, and append an ellipsis... cliplen  - the maximum length when clip is enabled
     *                       (defaults to $conf['max_chars']) ellipsis - the string to append to a clipped value
     *                       (defaults to $lang['strellipsis']) tag      - an HTML element name to surround the value.
     *                       class    - a class attribute to apply to any surrounding HTML element. align    - an align
     *                       attribute ('left','right','center' etc.) true     - (type='bool') the representation of
     *                       true. false    - (type='bool') the representation of false. function - (type='callback') a
     *                       function name, accepts args ($str, $params) and returns a rendering. lineno   - prefix
     *                       each line with a line number. map      - an associative array.
     *
     ...
     *
     * @param $tabs      The name of current section (Ex: intro, server, ...), or an array with tabs (Ex: sqledit.php
     *                   doFind function)
     ...
     *
     * @param $navlinks - An array with the the attributes and values that will be shown. See printLinksList for array
     *                  format.
     * @param $place    - Place where the $navlinks are displayed. Like 'display-browse', where 'display' is the file
     *                  (display.php)
     ...
     *                                        'multiactions' => array(
     *                                        'keycols' => Associative array of (URL variable => field name), // fields
     ...
     *                                        relative urls, usually the page itself (not '' !), or just a query
     *                                        string,
     ...
     *                                        ), ...
     *                                        );
     * @param $place                          Place where the $actions are displayed. Like 'display-browse', where
     *                                        'display' is the file (display.php) and 'browse' is the place inside that
     *                                        code (doBrowse).
